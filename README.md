...
The first use case is the ambulance to GP out-of-hours service referral (AMB → HAP, message 24). Message 23 (AMB → HA) follows the same pattern and is planned as a parallel use case layer.
