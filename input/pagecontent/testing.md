...
| Verzender - *zorgaanbieder* | `MessageHeader.sender` → `Organization`; also `Composition.author`; In absence of practioner data also `ServiceRequest.requester` → `Organization` |
