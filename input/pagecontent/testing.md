...
The generated TestScripts (and the fixtures they use) are committed under [`testscripts/output/`](https://github.com/Nictiz/AZ-IG/tree/main/testscripts/output), in the per-role deployment layout Conformancelab consumes.
